...
class FrontControllerCore extends Controller
{
    ...
    public function redirectWithNotifications()
    {
        ...
        return call_user_func_array(['tools\profiling\Tools', 'redirect'], func_get_args());
    }
    ...
    protected function sanitizeUrl(string $url): string
    {
        ...
        foreach ($params as $key => $value) {
            ...
            $params[Tools::safeOutput($key)] = is_array($value) ? array_walk_recursive($value, 'tools\profiling\Tools') : Tools::safeOutput($value);
        }
